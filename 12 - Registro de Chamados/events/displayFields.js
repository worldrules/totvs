...
//Habilitar alguns campos no formulario
	...
	if(atividade == 31){
		customHTML.append("changeDate();");
		customHTML.append("hideIt();");
		customHTML.append("$('#novoPrazo').prop('readonly','readonly');");
		customHTML.append("$('#comentario').prop('readonly','readonly');");
		customHTML.append("$('#novoPrazo').prop('style','pointer-events: none;');");
	}
	
	if(atividade == 5){
		customHTML.append("hidePraz();");
	}
